...
export function TranscriptEventRenderer({ event, followUpQuestionEntities, questionNumber, sectionName }) {
  ...
  // Base question - left aligned, compact
  if (kind === "base_question") {
    return (
      <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-4 opacity-85">
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-medium text-slate-300">{sectionName || ''}</span>
            </div>
  ...
  // Base answer - right aligned pill
  if (kind === "base_answer") {
    return (
      <div className="flex justify-end">
        <div className="bg-blue-600 rounded-full px-6 py-2">
