...
export const FOLLOWUP_PACK_CONFIGS = {
  ...
  "PACK_EMPLOYMENT_STANDARD": {
    ...
    fields: [
      { fieldKey: "PACK_EMPLOYMENT_Q01", semanticKey: "narrative", label: "In your own words, tell the complete story of this employment incident. Include who the employer was, roughly when it happened, what type of incident it was, what happened, what the outcome was, and why (if you know). Please provide as much detail as you can.", inputType: "textarea", placeholder: "Example: I worked at ABC Corporation from 2018 to 2020 as a warehouse supervisor. In November 2020, I was terminated for attendance issues after missing work several times due to car problems. I received a warning but was let go after the third absence.", required: true, aiProbingEnabled: true, isNarrativeOpener: true, isPrimaryNarrativeField: true, captures: ["employer", "month_year", "incident_type", "outcome"], includeInFacts: true, factsOrder: 1, includeInInstanceHeader: true, headerOrder: 1 },
