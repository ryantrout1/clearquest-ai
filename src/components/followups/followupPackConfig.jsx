...
export const FOLLOWUP_PACK_CONFIGS = {
  "PACK_INTEGRITY_APPS": {
    ...
    maxAiFollowups: 2, // CORRECTED: Match database max_ai_followups
    requiresCompletion: true,
    flagOnUnresolved: "red_flag",
    usePerFieldProbing: true,
    isV2Pack: true, // EXPLICIT: Mark as V2 pack for routing
    multiInstance: true,
    // DATABASE-FIRST: field_config loaded from database FollowUpPack.field_config
    // This pack now defers to database for field definitions (10 fields)
    fields: [] // Empty - database field_config is source of truth
  },
  "PACK_LE_APPS": {
    packId: "PACK_LE_APPS",
