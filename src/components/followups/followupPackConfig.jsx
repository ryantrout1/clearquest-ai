...
export const FOLLOWUP_PACK_CONFIGS = {
  ...
  "PACK_WORKPLACE_STANDARD": {
    ...
    factAnchors: [
      ...
      { key: "date_approx", label: "When it occurred", answerType: "month_year", priority: 2, multiInstanceAware: false, clarifierStyle: "micro", required: true },
      ...
      { key: "test_component", label: "Part of exam/process", answerType: "text", priority: 4, multiInstanceAware: false, clarifierStyle: "micro", required: false },
      { key: "action_taken", label: "Actions taken", answerType: "text", priority: 5, multiInstanceAware: false, clarifierStyle: "micro", required: false },
      { key: "outcome", label: "Final outcome", answerType: "text", priority: 6, multiInstanceAware: false, clarifierStyle: "micro", required: true },
      { key: "eligibility_to_reapply", label: "Eligibility to reapply", answerType: "text", priority: 7, multiInstanceAware: false, clarifierStyle: "micro", required: false }
    ],
    excludeFromProbing: [],
    requiresCompletion: true,
    flagOnUnresolved: "red_flag",
    ...
    fields: [
      {
        ...
        inputType: "textarea",
        placeholder: "Example: In 2021, during a written police test, I looked at another applicant's answers during a timed section. The proctor saw it and documented it. I wasn't accused of anything else, but the department disqualified me from moving forward.",
        required: true,
        aiProbingEnabled: true,
        isNarrativeOpener: true,
        isPrimaryNarrativeField: true,
        openingStrategy: "use_label_only",
        forceLabelAsFirstQuestion: true,
        allowOpeningClarifier: false,
        allowLLMAutoRewrite: false,
        autoSkipIfConfident: false,
        captures: ["incident_type", "date_approx", "agency_or_org", "test_component", "action_taken", "outcome"],
        includeInFacts: true,
        factsOrder: 1,
        includeInInstanceHeader: true,
        headerOrder: 1,
      ...
      {
        fieldKey: "PACK_WORKPLACE_Q03",
        semanticKey: "date_approx",
        label: "When did this occur (approx month/year)?",
        factsLabel: "Date",
        inputType: "month_year",
        placeholder: "e.g., June 2021 or around 2020",
        required: true,
        aiProbingEnabled: true,
        requiresMissing: ["date_approx"],
        probeInstructionOverride: "The candidate gave a vague date. Ask for at least an approximate timeframe like 'around 2021' or 'early 2019'.",
        includeInFacts: true,
        factsOrder: 3,
        includeInInstanceHeader: true,
        headerOrder: 3,
      ...
      },
      {
        ...
        required: false,
        aiProbingEnabled: true,
        requiresMissing: ["test_component"],
        includeInFacts: true,
        factsOrder: 5,
        includeInInstanceHeader: false,
        includeInNarrative: true,
      ...
      },
      {
        ...
        semanticKey: "eligibility_to_reapply",
        ...
        required: false,
        aiProbingEnabled: true,
        requiresMissing: ["eligibility_to_reapply"],
        includeInFacts: true,
        factsOrder: 8,
        includeInInstanceHeader: false,
        includeInNarrative: true,
