...
export const FOLLOWUP_PACK_CONFIGS = {
  ...
  "PACK_PRIOR_LE_APPS_STANDARD": {
    ...
    packDescription: "Thanks, I'll walk through your prior law enforcement applications one at a time so your investigator has a clear record. For each one, a short 1–2 sentence description and about what month and year you applied is perfect.",
    maxAiFollowups: 3,
    requiresCompletion: true,
    flagOnUnresolved: "warning",
    usePerFieldProbing: true,
