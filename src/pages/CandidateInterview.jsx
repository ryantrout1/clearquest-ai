                ...
                {session && (
                  <>
                    ...
                    <span className="text-xs text-slate-400 hidden sm:inline">
                      <span className="text-slate-500">Dept:</span> <span className="text-slate-300 font-mono">{session.department_code}</span>
                    </span>
                    <span className="text-slate-600 hidden md:inline">•</span>
                    <span className="text-xs text-slate-400 hidden md:inline">
                      <span className="text-slate-500">File:</span> <span className="text-slate-300 font-mono">{session.file_number}</span>
                    </span>
                  </>
                )}
              </div>
