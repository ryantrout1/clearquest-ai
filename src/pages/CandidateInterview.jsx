...
function CandidateInterviewInner() {
   ...
   */
  // MOVED: computeInterviewPhaseSOT
  ...
  // MOVED: saveAnswerToDatabase

  // MOVED: saveV2PackFieldResponse

  // MOVED: saveFollowUpAnswer

  // MOVED: handleCompletionConfirm

  // MOVED: getQuestionDisplayNumber
