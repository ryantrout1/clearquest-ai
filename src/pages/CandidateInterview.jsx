...
function CandidateInterviewInner() {
  ...
  // resolveAnchorToHumanQuestion and computeActivePromptText
  // imported from ./candidateInterview/promptHelpers
...
// DUPLICATE useEffect block removed
 ...
 // ===============================
  ...
  const _dynamicBottomPaddingPx = (typeof dynamicBottomPaddingPx !== 'undefined') ? dynamicBottomPaddingPx : 80;
  ...
  // DEV-ONLY: PASS logger (no verbose flag required - fires by default in dev/preview)
  try {
    if (typeof window !== 'undefined') {
      const hn = window.location?.hostname || '';
      const isDevEnv = hn.includes('preview') || hn.includes('localhost');
