...
export default function SessionDetails() {
  ...
  useEffect(() => {
    ...
    const hasSectionSummaries = Object.keys(sectionSummariesBySectionId).length > 0;
    const hasQuestionSummaries = Object.keys(questionSummariesByQuestionId).length > 0;
    ...
    const shouldAutoGenerate = 
      (!hasGlobalAISummary || !hasSectionSummaries || !hasQuestionSummaries) &&
    ...
    console.log('[AI-AUTO] START', { sessionId });

    handleGenerateAllAISummaries()
      .then((result) => {
        console.log('[AI-AUTO] DONE', { sessionId, result });
      })
      .catch((err) => {
        console.error('[AI-AUTO] ERROR', { sessionId, error: err });
      });
  }, [sessionId, session?.id, responses, followups, sectionSummariesBySectionId, questionSummariesByQuestionId]);
